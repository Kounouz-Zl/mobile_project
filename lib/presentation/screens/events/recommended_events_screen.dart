...
class RecommendedEventsScreen extends StatefulWidget {
  ...
  @override
  State<RecommendedEventsScreen> createState() => _RecommendedEventsScreenState();
}
              ...
              : recommendedEvents.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.recommend, size: 80, color: Colors.grey[400]),
                          ...
                          Text(
                            context.tr('set_preferences_for_personalized_events'),
