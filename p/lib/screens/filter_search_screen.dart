...
class _FilterSearchScreenState extends State<FilterSearchScreen> {
          ...
          Expanded(
            child: BlocBuilder<EventsCubit, EventsState>(
              builder: (context, state) {
                ...
                return const Center(child: Text('Apply filters to search'));
              },
            ),
          ),
        ],
  ...
  Widget _buildFilterResultCard(String eventId, String title, String location, String imagePath) {
