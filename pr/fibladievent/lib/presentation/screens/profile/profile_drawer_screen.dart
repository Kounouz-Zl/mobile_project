...
class _EnhancedProfileScreenState extends State<EnhancedProfileScreen> {
  ...
  Future<void> _loadUserStats() async {
    ...
    if (userState is UserLoaded) {
      try {
        // Fetch joined events, created events and favorites from API
        final joinedResp = await _apiService.get('/events/user/registered');
        final createdResp = await _apiService.get('/events/user/created');
        ...
        final allEventIds = <String>{
          ...joinedList.map((e) => (e['id'] ?? e['eventId']).toString()),
          ...createdList.map((e) => (e['id'] ?? e['eventId']).toString()),
        };
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSettingsItem(
                          ...
                          title: 'Interests',
                          subtitle:
                              '${user.selectedCategories.length} categories selected',
                          onTap: () {
                            _showEditCategoriesDialog(
                                context, user.selectedCategories);
                          },
